...
- **Аутентификация через Django пользователей** (не требует отдельных API ключей)
- URL для 1C: `https://your-domain.com/1c_exchange.php`
...
**Как работает:**
- 1C отправляет XML файлы через HTTP Basic Auth
