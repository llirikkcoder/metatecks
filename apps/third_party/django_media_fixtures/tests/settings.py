...
INSTALLED_APPS = (
    ...
    'apps.third_party.django_media_fixtures',  # include bellow django.contrib.staticfiles
    'apps.third_party.django_media_fixtures.tests.testapp.apps.TestAppConfig',
)
...
MEDIA_FIXTURES_FILES_FINDERS = (
    ...
    'apps.third_party.django_media_fixtures.finders.FileSystemFinder',
    # default (if you do not set MEDIA_FIXTURES_FILES_FINDERS)
    'apps.third_party.django_media_fixtures.finders.AppDirectoriesFinder',
)
