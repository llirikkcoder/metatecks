...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cml', '0005_import_updates'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='importedgroup',
            options={'ordering': ['-tn_priority', 'id']},
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='importedgroup',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='cml.importedgroup', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='importedgroup',
            name='tn_priority',
